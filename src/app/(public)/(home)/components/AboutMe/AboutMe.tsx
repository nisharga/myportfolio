        ...
        <div className='container '>
            ...
            >
                ...
                <div className='w-full lg:w-11/12 2xl:w-4/5 mt-2 lg:mt-12 mx-auto flex flex-col md:gap-4 lg:flex-row justify-between items-center'>
                    ...
                    <div
                        className='p-3 w-56 self-start md:w-2/5 lg:w-72 bg-white dark:bg-grey-800 flex flex-col gap-2 items-center rounded-2xl mx-auto lg:mx-16 peer-hover:-translate-y-2 hover:-translate-y-2 hover:grayscale-0 transition-transform duration-300 lg:-rotate-3 group grayscale peer-hover:grayscale-0
'
                    >
                        <Image
                            alt='profile'

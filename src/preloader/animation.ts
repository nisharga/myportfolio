    ...
    tl.to('body', {
        ...
        .to(
            '.preloader',
            {
                ...
                height: '0vh',
                ease: 'Power3.easeOut',
                onComplete: mobileLanding // Pass the function reference without invoking it
            },
            '-=2'
        )
        ...
        .from('.links .item', {
            ...
            ease: 'expo.easeOut',
            onComplete: animateMainShape // Pass the function reference without invoking it
        })
        .from('.main-circle', {
            duration: 1,
            opacity: 0,
            ease: 'power3.easeInOut',
            onComplete: animateShapes // Pass the function reference without invoking it
        })
        .from('.shapes .shape', {
            duration: 1,
            opacity: 0,
